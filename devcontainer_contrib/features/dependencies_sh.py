...
FEATMAKE_LINK = (
    "https://github.com/devcontainers-contrib/cli/releases/download/v0.0.17/featmake"
)
CHECKSUM_LINK = "https://github.com/devcontainers-contrib/cli/releases/download/v0.0.17/checksums.txt"

...
FEATMAKE_LINK = (
    "https://github.com/devcontainers-contrib/cli/releases/download/v0.0.27beta6/devcontainer-contrib"
)
CHECKSUM_LINK = "https://github.com/devcontainers-contrib/cli/releases/download/v0.0.27beta6/checksums.txt"
